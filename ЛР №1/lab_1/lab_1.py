...
#Дементьева
exp_1={'1_13':['1','3','6','9','13'],
    '1_17':['1','3','6','9','13','17'],
    '2_13':['1','3','6','9','13'],
    '2_17':['1','3','6','9','13','17']}

#исходные
'''exp_2={'1_13':['600','550','500','450','400'],
       '1_17':['600','550','540','490','440','390','340'],
       '2_13':['600','550','500','450','400','350'],
       '2_17':['600','540','490','440','390','340']}'''
#очищенные
exp_2={'1_13':['600','550','500','450','400'],
       '1_17':['550','540','490','440','390','340'],
       '2_13':['550','500','450','400','350'],
       '2_17':['540','490','440','340']}
...
#функция построения диаграммы информационного канала
def info_channel_diagram_window_create(info_channel_diagram, exposure_time, keyboard_num, key_num):
...
#функция обработки результатов эксперимента №2
def processing_experiment_2_results(key_num,keyboard_num,log_file_name, matrix_file_name, info_channel_diagram_show=True):
    ...
    exposure_time=[]
    for time in exp_2[f'{keyboard_num}_{key_num}']:
